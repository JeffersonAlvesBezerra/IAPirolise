...
#Criação do modelo
modelo = SVR(tol=0.001, verbose=False)
...
Y_pred_train=model.predict(X_train) #Utilização do modelo para predizer os dados de teste
...
#Salvando o Modelo
import joblib
joblib.dump(model, 'Kleber_SVR.pkl', compress=9)